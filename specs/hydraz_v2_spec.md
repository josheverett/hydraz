...
**Status:** v2 development is in progress. Phases 1-6 are complete (types, state machine, artifacts, investigator, architect, planner, consensus loop, worker fan-out, merge fan-in). Phase 7 (review panel) is next. The implementation plan is in `specs/hydraz_v2_plan.md`.
