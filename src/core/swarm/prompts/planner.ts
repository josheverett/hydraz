...
You must produce all of the following artifacts in the session's \`swarm/\` directory:

### 1. \`swarm/plan/plan.md\`
...
### 4. Worker briefs
For each worker, write a brief at \`swarm/workers/<worker-id>/brief.md\` containing:
