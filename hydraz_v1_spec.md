...
Add GitHub Actions CI so tests and type-checking run automatically on every PR and push to `main`/`dev`. The codebase has 421+ tests but no automation enforcing they pass before merge.
